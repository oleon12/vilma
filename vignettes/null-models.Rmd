...
<figure style="text-align: center;">
  <img src="figures/Fig_2.png" width="600" alt="Descriptive caption text" />
...
```{r plot-inside-outside-points-null, warning=FALSE, message=FALSE, fig.align='center', fig.width=7.2, fig.height=5.2, eval=run_terra}
library(tmap)
...
```{r plot-fixed-points-null, warning=FALSE, message=FALSE, fig.align='center', fig.width=7.2, fig.height=5.2, eval=run_terra}
library(tmap)
...
```{r plot-raster-sa, message=FALSE, warning=FALSE, fig.align='center', eval=run_terra, fig.width=7.2, fig.height=5.2}
library(tmap)
...
<br>
```{r plot-faith-pd-sa, warning=FALSE, message=FALSE, fig.align='center', eval=run_terra, fig.width=7.2, fig.height=5.2}
library(tmap)
...
<br>
```{r, message=FALSE, warning=FALSE, fig.align='center', eval=run_terra, fig.width=7.2, fig.height=5.2}
plot(pd_sa_null)
```
<br>
...
<br>
```{r, warning=FALSE, eval=run_terra, message=FALSE, fig.width=7.2, fig.height=5.2}
plot(pd_sa_null)
```
<br>
