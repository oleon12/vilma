...
```{r, warning=F, fig.align='center', fig.width=7.2, fig.height=5.2, eval = run_heavy}
...
```{r,message=FALSE, warning=FALSE, fig.align='center', fig.width=7, eval = run_heavy}
# Plot the PD data
...
```{r, echo=FALSE, fig.align='center', fig.dpi=230, message=FALSE, warning=FALSE, eval = run_heavy}
# Calculate the NTI index using root method
invisible(
  capture.output(
...
```{r, echo=FALSE, fig.align='center', fig.width=7.2, fig.height=5.2, message=FALSE, warning=FALSE, eval=run_leaflet}
# Check the NTI interactive map
view.vilma(prim_nti)
```
...
```{r, message=FALSE, warning=FALSE, fig.align='center', fig.width=7, fig.height=7, eval = run_heavy}
