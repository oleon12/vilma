...
<img src="figures/Trimeresurus_folder_2.png" alt="Fig. 1" style="display: block; margin: 0 auto; max-width: 100%; width: 700px;"/>
...
trimeresurus_rast <- read.csv("../inst/extdata/Trimeresurus_occ.csv")
```
